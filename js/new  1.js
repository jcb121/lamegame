function Player() {
	this.ai:            = false;
	this.style          = "topDown";
	this.spriteTorseSrc = "images/bkspr01.png";
	this.spriteLegsSrc  = "images/bkspr01-legs.png";
	this.frameX         = 128 //used for sprite clipping;
	this.frameY         = 128 //used for sprite clipping;
	this.speed          = 150;
	this.height         = 64;
	this.width          = 64;
	this.health         = 128;
	this.animations     = heroAnimations;
	this.controls       = heroControls;
